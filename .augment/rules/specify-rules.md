...
- 002-router-navigation: Added Dart 3.0+ (Sound Null Safety) via Flutter stable channel (FVM) + `go_router` (routing), `flutter_riverpod` (state), `flex_color_scheme` (theming)

- 001-project-init: Added Dart 3.0+ (Full Sound Null Safety) via Flutter Stable Channel
