...
// Expected implementation in: lib/src/features/receive/domain/isolate_event.dart
...
sealed class IsolateEvent with _$IsolateEvent {
  ...
  Map<String, dynamic> toMap() => switch (this) {
        ...
        ServerErrorEvent(:final message) => {'type': 'serverError', 'message': message},
        IncomingRequestEvent(
          :final requestId,
        ...
        TransferProgressEvent(:final sessionId, :final bytesReceived, :final totalBytes) => {
            'type': 'transferProgress',
            'sessionId': sessionId,
            'bytesReceived': bytesReceived,
            'totalBytes': totalBytes,
          },
        TransferCompletedEvent(:final sessionId, :final savedPath, :final checksumVerified) => {
  ...
  static IsolateEvent fromMap(Map<String, dynamic> map) {
    return switch (map['type'] as String) {
      ...
      'serverError' => IsolateEvent.serverError(message: map['message'] as String),
